...
export default function OrderCard({ productId, title, price, images }) {
  const { handlerOpenProductDatil, handlerRemoveToCart } = useShoppingCart();
  ...
  return (
    <div
      ...
      onClick={() => handlerOpenProductDatil({ id: productId })}
    >
      <figure className="">
        <img
          src={images[0]}
      ...
      <div className="w-full px-2 flex flex-col">
        ...
        <button
          onClick={(event) => handlerRemoveToCart(event, { id: productId })}
